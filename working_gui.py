...
class guiclass(tkinter.Frame):
    ...
    def initialize_user_interface(self):
        ...
        self.Q_entry.grid(row = 0, column = 1, sticky = tkinter.W + tkinter.E)
        #self.Q_entry.grid.column('#1', stretch=tkinter.YES)
        #self.Q_entry.pack(fill=1)
        ...
        self.A_entry.grid(row = 1, column = 1, sticky = tkinter.W + tkinter.E)
        ...
        self.R_entry.grid(row = 2, column = 1, sticky = tkinter.W + tkinter.E)
